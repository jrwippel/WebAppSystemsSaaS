...
{
    public class ProcessRecord : ITenantEntity
    {
        ...
        public ProcessRecord(DateTime date, Attorney attorney, Client client, TimeSpan horaInicial, TimeSpan horaFinal, string description, Department department, string solicitante, int activityTypeId)
        {
            Date = date;
            Attorney = attorney;
            Client = client;
        ...
        public ProcessRecord(int id, DateTime date, Attorney attorney, Client client, TimeSpan horaInicial, TimeSpan horaFinal, string description, Department department, string solicitante, int activityTypeId)
        {
            Id = id;
            Date = date; 
            Attorney = attorney;
