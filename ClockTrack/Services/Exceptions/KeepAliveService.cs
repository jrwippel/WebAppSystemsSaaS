namespace ClockTrack.Services.Exceptions
{
    public class KeepAliveService : IHostedService, IDisposable
    {
        ...
        private async void KeepAlive(object state)
        {
            try
            {
                ...
                var response = await _httpClient.GetAsync("https://clocktrack-cpbygygbayedaye9.eastus-01.azurewebsites.net/KeepAlive");
