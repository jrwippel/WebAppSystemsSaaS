...
namespace ClockTrack.Controllers
{
    ...
    public class ClientsController : Controller
    {
        ...
        public ClientsController(ClockTrackContext context, IWebHostEnvironment webHostEnvironment, ISessao isessao)
        {
            _context = context;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ClockTrackContext.Client' is null.");
            }
