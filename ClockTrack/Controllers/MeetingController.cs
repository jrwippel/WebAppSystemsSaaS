...
public class MeetingController : Controller
{
    ...
    public async Task<string> GenerateSummaryFromAzure(string transcribedText)
    {
        ...
        // Montar o corpo da requisi��o para a primeira API
        var requestBody = new
        {
        ...
        // Configurar a primeira requisi��o
        ...
        try
        {
            ...
            // Obter o cabe�alho operation-location
            if (!response.Headers.TryGetValues("operation-location", out var operationLocationValues))
            {
                return "Erro: Cabe�alho 'operation-location' n�o encontrado na resposta.";
            }
            ...
            for (int i = 0; i < 10; i++) // Tentativas limitadas
            {
                ...
                if (!statusResponse.IsSuccessStatusCode)
                {
                    ...
                    Console.WriteLine($"Erro na verifica��o do status: {statusResponse.StatusCode}, {errorStatusContent}");
        ...
        {
            Console.WriteLine($"Erro na requisi��o: {ex.Message}");
            return "Erro na requisi��o HTTP.";
        }
        catch (Exception ex)
        {
