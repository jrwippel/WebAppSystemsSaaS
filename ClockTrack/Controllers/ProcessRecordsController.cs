...
namespace ClockTrack.Controllers
{
    ...
    public class ProcessRecordsController : Controller
    {
        ...
        public ProcessRecordsController(ClockTrackContext context, ClientService clientService, ProcessRecordsService processRecordsService, AttorneyService attorneyService, ISessao isessao, DepartmentService departmentService)
        {
            _context = context;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ClockTrackContext.ProcessRecord'  is null.");
            }
